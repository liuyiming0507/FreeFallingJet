...
res=10 ##resolution: set the number following by the fname which depends on the selected mesh
scale=1
t_end = 12#8
B=0.01#0.001*res
dt = B*(scale/res)
...
fname = "geofolder/Jetflow_EM_thinres10" #resolution is 10
mesh = Mesh(fname + '.xml')
